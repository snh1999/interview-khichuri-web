...
const ZINC_LIGHT: Record<string, string> = {
...
const ZINC_DARK: Record<string, string> = {
...
const makePreset = (
  ...
  id,
  name,
  light: { ...ZINC_LIGHT, ...lightOverrides },
  dark: { ...ZINC_DARK, ...darkOverrides },
  radius,
  builtIn: true,
  createdAt: 0,
});

const makeBasePreset = (
  id: string,
  name: string,
...
export const BUILT_IN_PRESETS: TThemePreset[] = [
  ...
  makeBasePreset("builtin-zinc", "Zinc", { ...ZINC_LIGHT }, { ...ZINC_DARK }),
  ...
  // ── Accent themes (override on zinc base) ──────────────────
  makePreset(
    "builtin-amber",
    "Amber",
    {
  ...
  makePreset(
    ...
    },
    {
      ...
      "--primary-foreground": "oklch(0.405 0.101 131.063)",
      "--secondary": "oklch(0.2 0.003 250)",
      "--secondary-foreground": "oklch(0.9 0 0)",
      "--accent": "oklch(0.85 0.3 128)",
      "--accent-foreground": "oklch(0.12 0 0)",
      "--chart-1": "oklch(0.897 0.196 126.665)",
      "--chart-2": "oklch(0.768 0.233 130.85)",
      "--chart-3": "oklch(0.648 0.2 131.684)",
...
export const BUILT_IN_BASES = BUILT_IN_PRESETS.slice(0, 7);
export const BUILT_IN_ACCENTS = BUILT_IN_PRESETS.slice(7);
